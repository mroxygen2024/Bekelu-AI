  ...
  return (
    <div className="glass rounded-3xl shadow-xl p-8 mb-6 card-hover">
      ...
      <div className="flex items-center gap-6 mb-6">
        ...
        <div>
          <p className="text-sm text-gray-500">Matching Skills: {targetJobAnalysis.matching_skills.length}</p>
          <p className="text-sm text-gray-500">Missing Keywords: {targetJobAnalysis.missing_keywords.length}</p>
        </div>
      </div>
